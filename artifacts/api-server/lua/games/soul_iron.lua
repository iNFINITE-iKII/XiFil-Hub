...
startWithDRM(function(key, hwid)
    ...
    ----------------------------------------------------------------------------
    -- URL base modul — disajikan langsung dari server XiFil (bukan GitHub),
    -- supaya setiap perbaikan/update di server otomatis berlaku untuk semua
    -- pengguna tanpa perlu push ke repo terpisah.
    ----------------------------------------------------------------------------
