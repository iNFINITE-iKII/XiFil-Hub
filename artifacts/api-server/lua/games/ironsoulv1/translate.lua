...
local LANG_STRINGS = {
    Indonesia = {
        ...
        secBuffCard="Buff Card",
        lblBuffCard="🃏 Auto Buff Card",
        lblBuffCardSelect="Pilih Buff Card  (bisa lebih dari 1)",
        ...
        lblAutoSellScan="⚡ Auto Sell by Scan",
        lblAutoSellScanInterval="Interval Auto Sell Scan (detik)",
    ...
    English = {
      ...
      tabRoom="🗺️ Room",         tabForge="⚒️ Forge",
        ...
        secBuffCard="Buff Card",
        lblBuffCard="🃏 Auto Buff Card",
        lblBuffCardSelect="Select Buff Cards  (multiple allowed)",
        ...
        lblSellByRarityAuto="⚡ Auto Sell by Rarity",
        lblAutoSellScan="⚡ Auto Sell by Scan",
        lblAutoSellScanInterval="Auto Sell Scan Interval (sec)",
