--------------------------------------------------------------------------------
--// XiFil DRM Wrapper — IronSoul Beta | loader.lua
...
startWithDRM(function(key, hwid)
    ...
    ----------------------------------------------------------------------------
    -- URL base modul (ambil dari repo utama XiFil-Hub)
    ----------------------------------------------------------------------------
    local BASE = "https://xifil-hub-production.up.railway.app/api/lua/module/ironsoulbeta/"
