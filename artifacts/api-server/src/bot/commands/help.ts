  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        cmd: "/setaccountlimit",
        usage: "`[key] [count]`",
        desc: "Set berapa akun Roblox berbeda yang boleh pakai satu key secara bersamaan (1 = satu akun, 2–10 = multi-akun). Binding sekarang berbasis akun Roblox, bukan device.",
      },
    ],
  },
  {
